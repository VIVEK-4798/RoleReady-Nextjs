...
export default function HeroSection({ onCheckReadiness, onLearnMore }: HeroSectionProps) {
  return (
        ...
        <div className="flex flex-wrap items-center justify-between gap-10">
          ...
          <div className="flex-1 min-w-[300px] max-w-[600px] mb-10">
            <h1 className="text-4xl md:text-5xl lg:text-[3.5rem] font-extrabold leading-tight text-slate-900 mb-6 tracking-tight">
              ...
              <span className="relative inline-block text-[#5693C1]">
                Before You Apply
                <span className="absolute bottom-2 left-0 w-full h-2 bg-[#5693C1]/20 -z-10 rounded" />
              </span>
            </h1>
