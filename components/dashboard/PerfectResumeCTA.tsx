        ...
        <div className="relative overflow-hidden bg-gradient-to-r from-[#5693C1] to-[#4a80b0] rounded-2xl p-6 shadow-xl shadow-blue-500/10 mb-6 group">
            ...
            <div className="relative flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <Link
                    ...
                    className="flex items-center gap-2 px-8 py-4 bg-white text-[#5693C1] font-bold rounded-xl hover:bg-blue-50 hover:scale-105 active:scale-95 transition-all shadow-lg group"
                >
                    Unlock Now
