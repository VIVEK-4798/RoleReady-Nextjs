...
export function CertificatesSection({ certificates, onAdd, onEditCertificate }: CertificatesSectionProps) {
  return (
    <ProfileSection
      ...
      icon="badge"
      onAdd={onAdd}
      imageSrc="/images/certificates-section.svg" // Add your image path here
    >
      <div>
        ...
        {certificates?.length ? (
          <div className="space-y-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
            {certificates.map((cert, index) => (
              <div key={index} className="border-l-2 border-orange-400 pl-4 relative group">
                <button
                ...
                <p className="text-gray-600">by {cert.issuer}</p>
                {cert.issueDate && (
          ...
          <div className="flex flex-col items-center justify-center p-8 border-2 border-dashed border-gray-300 rounded-lg text-center">
            <svg className="w-12 h-12 text-gray-400 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
            </svg>
            <p className="text-gray-600 mb-4">Add your certifications to showcase your expertise</p>
            <button
              onClick={onAdd}
