        ...
        <div className="p-6">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 text-center md:text-left">
            <div className="relative w-40 h-40 flex-shrink-0">
              <svg className="w-40 h-40 transform -rotate-90">
                ...
                <circle
                  ...
                  fill="none"
                  strokeLinecap="round"
                  strokeDasharray={`${percentage * 4.398} 439.8`}
            ...
            <div className="flex-1 w-full flex flex-col items-center md:items-start">
              <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold shadow-sm ${status.bgColor} ${status.color} mb-6`}>
                <span>{status.icon}</span>
                <span>{status.label}</span>
              </div>

              <div className="grid grid-cols-2 md:grid-cols-3 gap-6 w-full">
                <div className="text-center md:text-left flex flex-col items-center md:items-start bg-gray-50 rounded-xl p-4">
                  <p className="text-3xl font-extrabold text-gray-900 mb-1">{snapshot?.skillsMatched || 0}</p>
                  <p className="text-sm font-medium text-gray-600">Skills Matched</p>
                </div>
                <div className="text-center md:text-left flex flex-col items-center md:items-start bg-gray-50 rounded-xl p-4">
                  <p className="text-3xl font-extrabold text-gray-900 mb-1">{snapshot?.skillsMissing || 0}</p>
                  <p className="text-sm font-medium text-gray-600">Skills Missing</p>
                </div>
                <div className="col-span-2 md:col-span-1 text-center md:text-left flex flex-col items-center md:items-start bg-gray-50 rounded-xl p-4">
                  <p className="text-3xl font-extrabold text-gray-900 mb-1">{snapshot?.requiredSkillsMet || 0}/{snapshot?.requiredSkillsTotal || 0}</p>
                  <p className="text-sm font-medium text-gray-600">Required Met</p>
                </div>
              </div>
            </div>
          </div>
