/**
 * Admin Internship Categories Client Component
 * 
 * Modern client-side component for managing internship categories with advanced features.
 */
...
export default function AdminInternshipCategoriesClient() {
  ...
  const fetchCategories = useCallback(async () => {
    try {
      ...
      const response = await fetch(`/api/admin/categories/internships?${params}`);
      ...
      render: (category: Category) => (
        <div className="space-y-1">
          ...
          <div className="text-xs text-gray-500">
            {category.internshipCount || 0} internships
          </div>
        </div>
      ),
      width: 'w-48',
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-[#5693C1]/10 to-blue-400/10 rounded-2xl p-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Internship Categories</h1>
            <p className="mt-2 text-gray-600">
              Organize and manage internship listings with color-coded categories
            </p>
          </div>
          <button
            onClick={() => {
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-5">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 mt-1">
                {categories.reduce((sum, cat) => sum + (cat.internshipCount || 0), 0)}
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
          ...
          <div className="md:col-span-2">
            ...
            >
              ...
              <option value="internshipCount">Most Internships</option>
            </select>
          </div>
            ...
            <div className="p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="pt-4 border-t border-gray-200 flex gap-3">
                  <button
                    type="submit"
                    className="flex-1 px-6 py-3 bg-gradient-to-r from-[#5693C1] to-blue-500 text-white rounded-xl hover:shadow-lg transition-all"
                  >
